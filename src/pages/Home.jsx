...
function Home() {
    return (
        ...
        <section className="home-description">
            ...
            <p>Residents enjoy high-speed internet, on-site laundry facilities, and the convenience of having utilities managed through the leasing office, eliminating the need to set up water, electricity, or other essential services. Whether you're studying, working, or connecting with neighbors, our community offers a convenient and supportive place to live.</p>
        </section>
        ...
        <section className="home-international">
            ...
            <p className="home-international-text">
                We warmly welcome international students and are familiar with the unique challenges of finding a home in a new country. Our fully furnished apartments mean you can arrive with just your luggage — no need to source furniture or appliances from scratch. With utilities coordinated through the leasing office and reliable high-speed internet included, you can focus on your studies and settling into life in Fayetteville without the stress of managing multiple service providers. We are conveniently located near the University of Arkansas campus and bus routes, and our team is always happy to answer questions and make the process as smooth as possible for you.
            </p>
        </section>
        <section className="home-contact" id="contact">
            ...
            <div className="home-contact-card">
                ...
                <a className="home-contact-link" href="tel:+14794458755">479-445-8755</a>
                <a className="home-contact-link" href="mailto:clark.eckels@gmail.com">clark.eckels@gmail.com</a>
            </div>
        </section>
        </>
    );
